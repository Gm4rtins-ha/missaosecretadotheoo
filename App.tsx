...
import { MissionCountdown } from './components/MissionCountdown.tsx';
...
const App: React.FC = () => {
  // Styles for the text outline effect which Tailwind doesn't support natively for text
          ...
          <section className="w-full max-w-2xl bg-slate-800/50 backdrop-blur-sm border border-slate-700 p-6 md:p-8 rounded-lg">
            ...
            <div className="grid md:grid-cols-2 gap-6 font-typewriter">
              <div className="space-y-1">
                ...
                <p className="text-lg text-white font-bold">{MISSION_DATA.date.split('-').reverse().join('/')}</p>
              </div>
